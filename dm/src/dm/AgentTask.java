...
public class AgentTask implements Runnable{
   ...
   ArrayList<ArrayList<Integer>> thePositions;
    HashSet<String>dictionary;
    BlockingQueue<DataFromAgentToDm>dataFromAgentToDmBlockingQueue;
    double indexOfSize;
           ...
           if(res==true){
              ...
              // System.out.println(config);
               ...
               try {
                   ...
                   dataFromAgentToDmBlockingQueue.put(new DataFromAgentToDm(Integer.valueOf(resToSendNumberThread),strResult,config));
               }catch (Exception e){
                   e.printStackTrace();
               }
